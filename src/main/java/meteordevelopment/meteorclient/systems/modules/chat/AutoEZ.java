...
import meteordevelopment.meteorclient.utils.player.Stats;
import meteordevelopment.meteorclient.utils.services.GlobalManager;
import meteordevelopment.meteorclient.utils.services.GlobalManager.DeathEntry;
...
import static meteordevelopment.meteorclient.utils.services.GlobalManager.deathEntries;
...
public class AutoEZ extends ReaperModule {
    ...
    public AutoEZ() {
        super(Categories.Chat, "auto-ez", "Send a message when you kill somebody.");
    }
