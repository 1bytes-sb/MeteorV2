...
import meteordevelopment.meteorclient.utils.player.Interactions.MineInstance;
import meteordevelopment.meteorclient.utils.render.Renderers.SimpleBedRender;
...
import meteordevelopment.meteorclient.utils.world.DamageCalculator;
import meteordevelopment.meteorclient.utils.world.DamageCalculator.BedPlacement;
...
public class BedGod extends ReaperModule {
    ...
    public BedGod() {
        super(Categories.Combat, "bed-god", "the best bed aura");
    }
