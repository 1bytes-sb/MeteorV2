...
public class SelfTrapPlus2 extends Module {
    public enum Mode {
        Full,
        Top,
        Side
    ...
    public SelfTrapPlus2() {
        super(Categories.Combat, "self-trap+", "Surrounds your head in blocks to prevent you from taking lots of damage.");
    }
