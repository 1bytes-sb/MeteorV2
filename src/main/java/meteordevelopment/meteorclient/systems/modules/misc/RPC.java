...
import meteordevelopment.meteorclient.utils.misc.ScreenUtil;
import meteordevelopment.meteorclient.utils.services.SpotifyService;
...
public class RPC extends ReaperModule {
    ...
    public RPC() {
        super(Categories.Misc, "discord-presence", "Discord RPC for Reaper");
        runInMainMenu = true;
    }
