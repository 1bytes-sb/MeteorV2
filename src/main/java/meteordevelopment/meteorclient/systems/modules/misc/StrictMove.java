...
import meteordevelopment.meteorclient.utils.misc.ModuleHelper;
...
public class StrictMove extends ReaperModule {
    ...
    public StrictMove() {
        super(Categories.Misc, "strict-move", "Mitigate lag-back from modules and/or strict anti-cheat");
    }
